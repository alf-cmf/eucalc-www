(defproject eucalc "0.1.0-SNAPSHOT"
...
;;;; PROXY>  :source-paths ["src/clj" "src/cljs" "src/cljc" "src/proxy"]
  ...
  :uberjar-name "eucalc.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main eucalc.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "eucalc.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/eucalc.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main eucalc.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main eucalc.system
                           :output-to "resources/public/js/compiled/eucalc.js"
                           :output-dir "target"
                           :source-map-timestamp true
...
;;;; PROXY>              :ring-handler eucalc-handler/dev-app
  ...
  :profiles {:dev
             ...
             {:source-paths ^:replace ["src/clj" "src/cljc"]
              :prep-tasks ["compile"
                           ["cljsbuild" "once" "min"]
                           ["run" "-m" "garden-watcher.main" "eucalc.styles"]]
              :hooks []
              :omit-source true
              :aot :all}})
