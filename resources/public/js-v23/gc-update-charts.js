...
// if (ds["warning_messages"]["land_use"].indexOf("No warning") != 0) landUseInfos += translate (ds["warning_messages"]["land_use"]) + "<br><br>";
 ...
 if (hasWarnings) document.getElementById('warnings-header').innerHTML = "<font color='#ff0000'>&nbsp;&nbsp;" + translate ("Info/Warning") + "&nbsp;&nbsp;</font>"
 else             document.getElementById('warnings-header').innerHTML = "<font color='#737373'>&nbsp;&nbsp;" + translate ("Info/Warning") + "&nbsp;&nbsp;</font>"
